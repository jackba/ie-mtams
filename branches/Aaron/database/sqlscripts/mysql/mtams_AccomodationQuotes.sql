...
DROP TABLE IF EXISTS `AccomodationQuotes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `AccomodationQuotes` (
  `idAccomodationQuotes` int(11) NOT NULL,
  `DateCheckin` timestamp NULL DEFAULT NULL,
  ...
  KEY `fk_AccomodationQuotes_Quotes1` (`Quotes_idQuotes`),
...
LOCK TABLES `AccomodationQuotes` WRITE;
/*!40000 ALTER TABLE `AccomodationQuotes` DISABLE KEYS */;
/*!40000 ALTER TABLE `AccomodationQuotes` ENABLE KEYS */;
UNLOCK TABLES;
