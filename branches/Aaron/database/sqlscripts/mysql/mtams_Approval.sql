...
CREATE TABLE `Approval` (
  ...
  `SectionApproved` int(11) DEFAULT NULL,
  `Notes` varchar(200) DEFAULT NULL,
  `Date` timestamp NULL DEFAULT NULL,
  `Application_idApplication` int(11) NOT NULL,
  `Account_idAccount` int(11) NOT NULL,
  PRIMARY KEY (`idApproval`),
  KEY `fk_Approval_Application1` (`Application_idApplication`),
  KEY `fk_Approval_Account1` (`Account_idAccount`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Persons who have to Approve sections of the application';
