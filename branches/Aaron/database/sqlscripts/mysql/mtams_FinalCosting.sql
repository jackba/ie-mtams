...
DROP TABLE IF EXISTS `FinalCosting`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `FinalCosting` (
  `idFinalCosting` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `fk_FinalCosting_Quotes1` (`Quotes_idQuotes`),
...
LOCK TABLES `FinalCosting` WRITE;
/*!40000 ALTER TABLE `FinalCosting` DISABLE KEYS */;
/*!40000 ALTER TABLE `FinalCosting` ENABLE KEYS */;
UNLOCK TABLES;
