...
DROP TABLE IF EXISTS `RewardsProgram`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `RewardsProgram` (
  `idRewardsProgram` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `fk_RewardsProgram_TravelerProfile1` (`TravelerProfile_idTravelerProfile`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Frequent Fligher etc';
...
LOCK TABLES `RewardsProgram` WRITE;
/*!40000 ALTER TABLE `RewardsProgram` DISABLE KEYS */;
/*!40000 ALTER TABLE `RewardsProgram` ENABLE KEYS */;
UNLOCK TABLES;
