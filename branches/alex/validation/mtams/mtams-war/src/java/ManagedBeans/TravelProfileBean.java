...
public class TravelProfileBean implements Serializable {
    ...
    @Pattern(message = "Incorrect ID: Must be 13-15 long", regexp = "[0-9a-zA-Z]{13,15}")
    private String idNo;
    private String busAddress;
    @Pattern(message = "Incorrect Number must be 10 long", regexp = "[0-9]{10}")
    private String busPhone;
    @Pattern(message = "Incorrect Number must be 10 long", regexp = "[0-9]{0,10}")
    ...
    @Pattern(message = "Incorrect Passport ID must be 8-10", regexp = "[0-9a-zA-Z]{8,10}")
    private String passportNo;
    private String country;
    private Date dateOfIssue;
    @Future(message = "Date needs to be further in the future")
