...
CREATE TABLE "APPROVALCHAIN" (
  ...
  "APPLICATIONCOMPLETE" INT NOT NULL DEFAULT 0,
  "SCHOOLADMIN" INT NOT NULL DEFAULT 0,
  "SCHOOLADMINCOMPLETE" INT NOT NULL DEFAULT 0,
  "SCHOOLADMINAPPROVED" INT NOT NULL DEFAULT 0,
  "HOD" INT NOT NULL DEFAULT 0,
  "HODCOMPLETE" INT NOT NULL DEFAULT 0,
  "HODAPPROVED" INT NOT NULL DEFAULT 0,
  "FINANCE" INT NOT NULL DEFAULT 0,
  "FINANCECOMPLETE" INT NOT NULL DEFAULT 0,
  "FINANCEAPPROVED" INT NOT NULL DEFAULT 0,
  "PVC" INT NOT NULL DEFAULT 0,
  "PVCCOMPLETE" INT NOT NULL DEFAULT 0,
  "PVCAPPROVED" INT NOT NULL DEFAULT 0,
  "FINALFINANCE" INT NOT NULL DEFAULT 0,
  "FINALCOMPLETE" INT NOT NULL DEFAULT 0,
  "FINALAPPROVED" INT NOT NULL DEFAULT 0,
  PRIMARY KEY ("ID"),
