...
CREATE TABLE "ACCOUNTDEPARTMENT" (
  ...
  CONSTRAINT "FK_ACCOUNTDEPRTMENT_ACCOUNT" FOREIGN KEY ("IDDEPARTMENT") REFERENCES "DEPARTMENT" ("IDDEPARTMENT")  ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT "FK_ACCOUNTDEPRTMENT_DEPARTMENT" FOREIGN KEY ("IDACCOUNT") REFERENCES "ACCOUNT" ("IDACCOUNT") ON DELETE NO ACTION ON UPDATE NO ACTION
);
--
-- ------------------------------------------------------
--
